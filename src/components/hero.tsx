  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 768) {
        // mobile
        setRanges({ y1: "950%", y2: "800%", y3: "80%", y4: "300%" });
  ...
  return (
    ...
    >
      ...
      <div className="flex relative w-full h-[40%] lg:h-[50%] xl:h-[40%]">
        ...
        <motion.div
          style={{ y: y1 }}
          className="flex w-full h-[70dvh]  right-0 lg:h-[90dvh] xl:h-full mt-20 xl:mt-0 xl:top-0  relative z-5 xl:w-full justify-end"
        >
          <img
            src="./imagerkd2.webp"
            className="absolute h-[100%]  h-[100%] object-cover lg:right-[-30%] xl:right-0 lg:mr-20"
            alt="Rajeev Das"
          />
        </motion.div>
